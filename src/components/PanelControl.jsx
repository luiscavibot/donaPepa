...
const PanelControl = (props) => {
    ...
    return (
        <>
            <header className="navbar navbar-dark sticky-top  flex-md-nowrap p-0 border">
                                ...
                                <div id="collapseTwo" className="accordion-collapse collapse show" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
                                    <div className="accordion-body">
                                        ...
                                        {/* <ul className="list-group">
                                            <button className="list-group-item text-start">VENTAS</button>
                                            <button className="list-group-item text-start">LIQUIDACIÓN MAESTRO</button>
                                        </ul>                      */}
                                    </div>
                                </div>
                            </div>
                    ...
                    <Switch>
                        <Route path={`${path}/reportes-ventas`}>
                            <div className="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                                <h1 className="h5">Reporte de ventas</h1>
                            </div>
                        </Route>
